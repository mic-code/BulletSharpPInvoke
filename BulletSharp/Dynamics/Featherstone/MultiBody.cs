	...
	public class MultiBody : IDisposable
	{
		...
		*/
		...
		public void SetupFixed(int linkIndex, double mass, Vector3d inertia, int parent,
			Quaternion rotParentToThis, Vector3d parentComToThisPivotOffset, Vector3d thisPivotToThisComOffset,
		...
		public void SetupPlanar(int i, double mass, Vector3d inertia, int parent, Quaternion rotParentToThis,
		...
		public void SetupPrismatic(int i, double mass, Vector3d inertia, int parent,
			Quaternion rotParentToThis, Vector3d jointAxis, Vector3d parentComToThisPivotOffset,
