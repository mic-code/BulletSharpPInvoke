...
namespace BulletSharp
{
	...
	internal static class UnsafeNativeMethods
	{
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btMultiBody_setupFixed(IntPtr obj, int linkIndex, double mass, [In] ref Vector3d inertia, int parent, [In] ref Quaternion rotParentToThis, [In] ref Vector3d parentComToThisPivotOffset, [In] ref Vector3d thisPivotToThisComOffset, bool deprecatedDisableParentCollision);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btMultiBody_setupPlanar(IntPtr obj, int i, double mass, [In] ref Vector3d inertia, int parent, [In] ref Quaternion rotParentToThis, [In] ref Vector3d rotationAxis, [In] ref Vector3d parentComToThisComOffset, bool disableParentCollision);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btMultiBody_setupPrismatic(IntPtr obj, int i, double mass, [In] ref Vector3d inertia, int parent, [In] ref Quaternion rotParentToThis, [In] ref Vector3d jointAxis, [In] ref Vector3d parentComToThisPivotOffset, [In] ref Vector3d thisPivotToThisComOffset, bool disableParentCollision);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btMultiBody_setupRevolute(IntPtr obj, int linkIndex, double mass, [In] ref Vector3d inertia, int parentIndex, [In] ref Quaternion rotParentToThis, [In] ref Vector3d jointAxis, [In] ref Vector3d parentComToThisPivotOffset, [In] ref Vector3d thisPivotToThisComOffset, bool disableParentCollision);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btMultiBody_setupSpherical(IntPtr obj, int linkIndex, double mass, [In] ref Vector3d inertia, int parent, [In] ref Quaternion rotParentToThis, [In] ref Vector3d parentComToThisPivotOffset, [In] ref Vector3d thisPivotToThisComOffset, bool disableParentCollision);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btTransformUtil_calculateDiffAxisAngleQuaternion([In] ref Quaternion orn0, [In] ref Quaternion orn1a, out Vector3d axis, out double angle);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btTransformUtil_calculateVelocityQuaternion([In] ref Vector3d pos0, [In] ref Vector3d pos1, [In] ref Quaternion orn0, [In] ref Quaternion orn1, double timeStep, out Vector3d linVel, out Vector3d angVel);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
